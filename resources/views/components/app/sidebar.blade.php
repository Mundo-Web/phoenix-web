    ...
    <div id="sidebar"
        ...
        <div class="space-y-8">
          ...
          @endif
                ...
                <x-menu.item id="clients" href="{{ route('Admin/Clients.jsx') }}" icon="fa fa-solid fa-users">
                    Clientes
                    @if (($clientsCount ?? 0) !== 0)
                        <x-slot name="tag">
                            {{ $clientsCount }}
                ...
                <x-menu.item id="payment-history" href="{{ route('payment-history.index') }}" icon="fa fa-credit-card">
                    Historial de pagos
                </x-menu.item>
            ...
            <x-menu.group title="Productos">
                ...
                <x-menu.item id="products" href="{{ route('products.index') }}"
                    icon="fas fa-box">Productos</x-menu.item>
            ...
            <x-menu.group title="Contenido de la web">
                ...
                <x-menu.item id="slider" href="{{ route('slider.index') }}"
                    icon="fa fa-solid fa-image">Sliders</x-menu.item>
                <x-menu.item id="banners" href="{{ route('banners.index') }}"
                    icon="fa fa-solid fa-image">Disciplinas</x-menu.item>
                <x-menu.item id="servicios" href="{{ route('servicios.index') }}"
                    icon="fas fa-sliders-h">Beneficios</x-menu.item>
                <x-menu.item id="popup" href="{{ route('popup.index') }}"
                    icon="fas fa-sliders-h">Popup</x-menu.item>
                <x-menu.item id="strength" href="{{ route('strength.index') }}"
                    icon="fa-regular fa-clipboard">Estadisticas</x-menu.item>
                <x-menu.item id="project" href="{{ route('project.index') }}"
                    icon="fas fa-users">Equipo</x-menu.item>
                ...
                <x-menu.item id="homeview" href="{{ route('homeview.edit', 1) }}" icon="fas fa-pencil-alt">Textos
                    Home</x-menu.item>
                <x-menu.item id="nosotrosview" href="{{ route('nosotrosview.edit', 1) }}"
                    icon="fas fa-pencil-alt">Textos Nosotros</x-menu.item>
                <x-menu.item id="contactoview" href="{{ route('contactoview.edit', 1) }}"
                    icon="fas fa-pencil-alt">Textos Contacto</x-menu.item>
            ...
            <x-menu.group title="Datos de la empresa">
                <x-menu.item id="datosgenerales" href="{{ route('datosgenerales.edit', 1) }}"
                    icon="fas fa-address-card">Datos Generales</x-menu.item>
                <x-menu.item id="shortcode" href="{{ route('shortcode.edit', 1) }}"
                    icon="fas fa-address-card">Shortcode Head/Body</x-menu.item>
