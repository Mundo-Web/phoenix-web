<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <form action="{{ route('contactoview.update', $contacto->id) }}"  method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <div class="rounded shadow-lg p-4 px-4 w-full">
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                                    ...
                                    <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-xl tracking-tight">Seccion Portada</h2>
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="title1section2">Subtitulo</label>
                                        <div class="relative mb-2 ">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <i class="w-6 text-gray-500 fas fa-edit"></i>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <textarea type="text" id="description1section" name="description1section"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese la descripcion">{{ $contacto->description1section }}</textarea>
                                        </div>
                                    </div>


                                    <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-xl tracking-tight">Sección Banner</h2>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <input type="text" id="subtitle2section" name="subtitle2section"
                                                value="{{ $contacto->subtitle2section }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-2">
                                            ...
                                            <input type="text" id="title2section" name="title2section"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese el texto" value="{{$contacto->title2section}}" >
                                        </div>
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="description3section">Boton texto</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute top-3 left-0 flex items-center pl-3 pointer-events-none">
                                                    <i class="w-6 text-gray-500 fas fa-edit"></i>
                                            ...
                                            <input type="text" id="description3section" name="description3section"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ingrese el texto" value="{{$contacto->description3section}}" >
                                        </div>
                                    </div>
                                    ...
                                    <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-xl tracking-tight">Sección FAQs</h2>


                                    <div class="md:col-span-5">
                                        <label for="title3section">Faqs</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <i class="w-6 text-gray-500 fas fa-edit"></i>
