            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="number" id="order" name="order" value="{{$project->order}}"
              ...
              <div class="md:col-span-5">
                <label for="descripcion">Cargo o Especialidad</label>
                <div class="relative mb-2  mt-2">
                  <svg class="absolute top-2 left-2 w-5 h-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg"
                  version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
                  y="0" viewBox="0 0 469.336 469.336" style="enable-background:new 0 0 512 512" xml:space="preserve"
                  class="">
                  <g>
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 mt-2">
                  <img src="{{ asset($project->imagen) }}" onerror="this.onerror=null;this.src='{{ asset('images/imagen/noimagen.jpg') }}';"
                    class="w-auto max-h-48 object-contain object-top  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
              </div>
