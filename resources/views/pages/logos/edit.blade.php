              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 mt-2">
                  <img src="{{ asset($logo->url_image) }}" onerror="this.onerror=null;this.src='{{ asset('images/imagen/noimagen.jpg') }}';"
                    class="w-auto max-h-20 object-contain object-top  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
              </div>


              <div class="md:col-span-5">
                <label for="imagen">Imagen Logo (Tamaño referencial: 220x80 - .png .webp)</label>
                <div class="relative mb-2  mt-2">
